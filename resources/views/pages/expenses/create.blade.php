                    ...
                    <div class="card-header pb-0 p-3">
                        <div class="row">
                            <div class="col-md-8 d-flex align-items-center">
                                <h6 class="mb-3">Add Expesnse Details</h6>
                            </div>
                        </div>
                    </div>
                         ...
                         <form method='POST'
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-9">
                                    <label class="form-label fs-5 text-dark">Expense Id</label>
                                ...
                                <div class="form-inline mb-3 col-md-9">
                                    <label class="my-1 mr-2 fs-5 text-dark">Exepense category</label>
                                ...
                                <div class="mb-3 col-md-9">
                                    ...
                                    <input type="text" placeholder="eg.1000000" name="facility_id"
                                        class="form-control border border-2 p-2">
                                    {{-- @error('room_number')
                                        <p class='text-danger inputerror'>{{ $message }} </p>
                                    @enderror --}}
