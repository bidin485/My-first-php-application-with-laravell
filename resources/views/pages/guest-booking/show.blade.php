                        ...
                        <div class="col-md-6">
                            <div class="card-body p-3">
                                <div class="text-end pt-1">
                                    ...
                                    <h4 class="mb-0">{{ $booking->hostelRoom->room_number }}</h4>
                                </div>
                                <hr class="dark horizontal my-0">
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Bed Number</p>
                                    <p class="text-2xl mb-0">{{ $booking->bed->bed_number }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Room Type</p>
                                    <p class="text-2xl mb-0">{{ $booking->hostelRoom->hostelRoomType->room_type }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Guest Name</p>
                                    <p class="text-2xl mb-0">{{ $booking->first_name }} {{ $booking->last_name }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Guest Email</p>
                                    <p class="text-2xl mb-0">{{ $booking->user->email }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Check In Date</p>
                                    <p class="text-2xl mb-0">{{ $booking->check_in_date }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Check Out Date</p>
                                    <p class="text-2xl mb-0">{{ $booking->check_out_date }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Amount Paid</p>
                                    <p class="text-2xl mb-0">{{ $booking->amount_paid }}</p>
                                </div>
                                <div class="d-flex align-items-center justify-content-between pt-2">
                                    <p class="mb-0 text-bg-primary text-2xl font-weight-bolder">Balance</p>
                                    <p class="text-2xl mb-0">{{ $booking->balance }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
